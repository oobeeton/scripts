...
class AzureImportUtil():
    ...
    def get_network_resources(self, resource_group):
        ...
        resource_group['resources']['network']['applicationSecurityGroups'] = make_request(self.network_client.application_security_groups.list, [resource_group_name])
        ...
        resource_group['resources']['network']['virtualWans'] =  make_request(self.network_client.virtual_wans.list_by_resource_group, [resource_group_name])
    ...
    def get_databricks_resources(self, resource_group):
        ...
        resource_group['resources']['databricks']['workspaces'] = make_request(self.databricks_client.workspaces.list_by_resource_group, [resource_group_name])
    ...
    def get_front_door_resources(self, resource_group):
        ...
        resource_group['resources']['frontdoor']['afds'] = []        # Front Door Standard/Premium
        resource_group['resources']['frontdoor']['frontdoors'] = []  # Front Door (Classic)
        resource_group_name = resource_group['resourceGroupName']
        ...
        for profile in make_request(self.cdn_client.profiles.list_by_resource_group, [resource_group_name]):
            ...
            for endpoint in make_request(self.cdn_client.afd_endpoints.list_by_profile, [resource_group_name, profile['name']]):
                profile['endpoints'].append(endpoint)

            for originGroup in make_request(self.cdn_client.afd_origin_groups.list_by_profile, [resource_group_name, profile['name']]):
                originGroup['origins'] = []
                for origin in make_request(self.cdn_client.afd_origins.list_by_origin_group, [resource_group_name, profile['name'], originGroup['name']]):
                    originGroup['origins'].append(origin)
                profile['originGroups'].append(originGroup)

            resource_group['resources']['frontdoor']['afds'].append(profile)
        ...
        frontdoor = resource_group['resources']['frontdoor']
        return len(frontdoor['afds']) + len(frontdoor['frontdoors'])
    ...
    def get_app_service_resources(self, resource_group):
        ...
        return len(resource_group['resources']['appservice']['appServicePlans'] + resource_group['resources']['appservice']['webApps'])
    ...
    def get_managed_identity_resources(self, resource_group):
        ...
        resource_group['resources']['managedidentity']['userAssignedIdentities'] = make_request(self.msi_client.user_assigned_identities.list_by_resource_group, [resource_group_name])
    ...
    def get_cache_for_redis_resources(self, resource_group):
        ...
        resource_group['resources']['cacheforredis']['cachesForRedis'] = make_request(self.redis_client.redis.list_by_resource_group, [resource_group_name])
    ...
    def get_data_factory_resources(self, resource_group):
        ...
        resource_group_name = resource_group['resourceGroupName']
        resource_group['resources']['datafactory']['dataFactories'] = make_request(self.datafactory_client.factories.list_by_resource_group, [resource_group_name])
    ...
    def get_log_analytics_resources(self, resource_group):
        ...
        resource_group_name = resource_group['resourceGroupName']
        resource_group['resources']['loganalytics']['workspaces'] = make_request(self.log_analytics_client.workspaces.list_by_resource_group, [resource_group_name])
    ...
    def get_event_hub_resources(self, resource_group):
        ...
        for namespace in make_request(self.event_hub_client.namespaces.list_by_resource_group, [resource_group_name]):
            ...
            for eventHub in make_request(self.event_hub_client.event_hubs.list_by_namespace, [resource_group_name, namespace['name']]):
                resource_group['resources']['eventhubs']['eventHubs'].append(eventHub)

        return len(resource_group['resources']['eventhubs']['eventHubs']) + \
               len(resource_group['resources']['eventhubs']['eventHubsNamespaces'])
    ...
    def get_logic_apps_resources(self, resource_group):
        ...
        resource_group_name = resource_group['resourceGroupName']
        resource_group['resources']['logicapps']['workflows'] = make_request(self.logic_client.workflows.list_by_resource_group, [resource_group_name])
    ...
    def get_event_grid_resources(self, resource_group):
        ...
        resource_group_name = resource_group['resourceGroupName']
        resource_group['resources']['eventgrid']['domains'] = make_request(self.event_grid_client.domains.list_by_resource_group, [resource_group_name])
        resource_group['resources']['eventgrid']['topics'] = make_request(self.event_grid_client.topics.list_by_resource_group, [resource_group_name])
        return len(resource_group['resources']['eventgrid']['domains']) + \
               len(resource_group['resources']['eventgrid']['topics'])
